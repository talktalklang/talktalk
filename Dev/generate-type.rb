...
insert "Sources/TalkTalkSyntax/Visitors/OldFormatter.swift", <<SWIFT
...
insert "Sources/TypeChecker/Visitors/PatternVisitor.swift", <<SWIFT
	public func visit(_ expr: #{typeName}Syntax, _ context: Context) throws -> Pattern{
...
insert "Sources/TalkTalkSyntax/Formatter/FormatterVisitor.swift", <<SWIFT
