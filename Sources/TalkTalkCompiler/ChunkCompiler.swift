...
//		chunk.emit(byte: Byte(expr.elements.count), line: expr.location.line)
	...
	public func visit(_ expr: AnalyzedEnumDecl, _ context: Chunk) throws {
		#warning("Generated by Dev/generate-type.rb")
	}
	public func visit(_ expr: AnalyzedEnumCaseDecl, _ context: Chunk) throws {
		#warning("Generated by Dev/generate-type.rb")
	}
	public func visit(_ expr: AnalyzedMatchStatement, _ context: Chunk) throws {
		#warning("Generated by Dev/generate-type.rb")
	}
	public func visit(_ expr: AnalyzedCaseStmt, _ context: Chunk) throws {
		#warning("Generated by Dev/generate-type.rb")
	}
	public func visit(_ expr: AnalyzedEnumMemberExpr, _ context: Chunk) throws {
		#warning("Generated by Dev/generate-type.rb")
	}
	// GENERATOR_INSERTION
