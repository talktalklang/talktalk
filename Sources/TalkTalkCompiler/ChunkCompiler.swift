...
//		chunk.emit(opcode: .get, line: expr.location.line)
	...
	public func visit(_ expr: AnalyzedDictionaryLiteralExpr, _ context: Chunk) throws {
		#warning("Generated by Dev/generate-type.rb")
		fatalError("TODO")
	}
	public func visit(_ expr: AnalyzedDictionaryElementExpr, _ context: Chunk) throws {
		#warning("Generated by Dev/generate-type.rb")
		fatalError("TODO")
	}
	// GENERATOR_INSERTION
