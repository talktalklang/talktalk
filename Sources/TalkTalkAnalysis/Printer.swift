...
public struct AnalysisPrinter: AnalyzedVisitor {
	...
	@StringBuilder public func visit(_ expr: AnalyzedSubscriptExpr, _: Void) throws -> String {
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedDictionaryLiteralExpr, _: Context) throws -> String {
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedDictionaryElementExpr, _: Context) throws -> String {
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedProtocolDecl, _: Context) throws -> String {
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedProtocolBodyDecl, _: Context) throws -> String {
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedFuncSignatureDecl, _: Context) throws -> String {
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedEnumDecl, _: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedEnumCaseDecl, _: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedMatchStatement, _: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedCaseStmt, _: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedEnumMemberExpr, _: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedInterpolatedStringExpr, _: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		dump(expr)
	}

	@StringBuilder public func visit(_ expr: AnalyzedForStmt, _ context: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		dump(expr)
	}
