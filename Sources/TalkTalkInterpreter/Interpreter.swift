...
public struct Interpreter: AnalyzedVisitor {
	...
	public func visit(_: AnalyzedArrayLiteralExpr, _: Scope) throws -> Value {
		fatalError("TODO")
	}
	...
	public func visit(_: AnalyzedParam, _: Scope) throws -> Value {
		.none
	}
	...
	public func visit(_: AnalyzedSubscriptExpr, _: Scope) throws -> Value {
		fatalError("TODO")
	}

	public func visit(_: AnalyzedDictionaryLiteralExpr, _: Scope) throws -> Value {
		fatalError("TODO")
	}

	public func visit(_: AnalyzedDictionaryElementExpr, _: Scope) throws -> Value {
		fatalError("TODO")
	}

	public func visit(_: AnalyzedProtocolDecl, _: Scope) throws -> Value {
		.none
	}

	public func visit(_: AnalyzedProtocolBodyDecl, _: Scope) throws -> Value {
		.none
	}

	public func visit(_: AnalyzedFuncSignatureDecl, _: Scope) throws -> Value {
		.none
	}
	...
	public func visit(_ expr: AnalyzedForStmt, _ context: Scope) throws -> Value {
		#warning("Generated by Dev/generate-type.rb")
		return .none
	}
