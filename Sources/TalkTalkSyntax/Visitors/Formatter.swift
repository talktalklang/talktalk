...
public struct Formatter: Visitor {
		...
		if !expr.body.isEmpty {
			...
			result += try indenting {
				...
				for stmt in expr.body {
					inner.append(try stmt.accept($0, context))
				}
	...
	public func visit(_ expr: EnumMemberExprSyntax, _ context: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		return "(typeName)"
	}

	public func visit(_ expr: InterpolatedStringExprSyntax, _ context: Context) throws -> String {
		#warning("Generated by Dev/generate-type.rb")
		return "(typeName)"
	}
